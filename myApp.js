...
const createManyPeople = (arrayOfPeople, done) => {
  arrayOfPeople = [{name: 'anuska', age: 27, favoriteFoods: ['coffee', 'bread']},
                   {name: 'hirok', age: 41, favoriteFoods: ['paneer', 'bakarwadi']},
                   {name: 'satarupa',age: 35, favoriteFoods:['potol','mushroom']}];
